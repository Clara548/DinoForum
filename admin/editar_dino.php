...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE dinosaurio SET 
            nombre = ?, nombre_en = ?, 
            nombre_cientifico = ?, nombre_cientifico_en = ?, 
            anio_descubrimiento = ?,
            periodo = ?, periodo_en = ?,
            dieta = ?, dieta_en = ?,
            tamano = ?, tamano_en = ?,
    ...
    if ($stmt->execute([$nombre, $nombre_en, $cientifico, $cientifico_en, $anio_descubrimiento,
        $periodo, $periodo_en, $dieta, $dieta_en, $tamano, $tamano_en, $peso, $peso_en, 
        $descripcion, $descripcion_en, $imagen, $id])) {
        $mensaje = '<div class="success">✅ Dinosaurio actualizado correctamente</div>';
        $stmt = $pdo->prepare("SELECT * FROM dinosaurio WHERE id = ?");
        $stmt->execute([$id]);
        $dino = $stmt->fetch();
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Editar Dinosaurio - Con Traducción</title>
...
<body>
    <div class="form-container">
        ...
        <p class="subtitle"><i class="fas fa-language"></i> Usa los botones de traducción para traducir del español al inglés</p>
        <?php echo $mensaje; ?>
        <form method="post" enctype="multipart/form-data">
            <div class="lang-row">
                <div class="lang-col">
                    ...
                    <label>Nombre *</label>
                    <input type="text" name="nombre" id="nombre_es" value="<?= htmlspecialchars($dino['nombre']) ?>" required>
                    <label>Nombre científico</label>
                    <input type="text" name="cientifico" id="cientifico_es" value="<?= htmlspecialchars($dino['nombre_cientifico']) ?>">
                    ...
                    <textarea id="descripcion_es" name="descripcion" class="editor-textarea"><?= htmlspecialchars($dino['descripcion']) ?></textarea>
                ...
                <div class="lang-col">
                    ...
                    <label>Name *</label>
                    <input type="text" name="nombre_en" id="nombre_en" value="<?= htmlspecialchars($dino['nombre_en']) ?>" required>
                    <label>Scientific name</label>
                    <input type="text" name="cientifico_en" id="cientifico_en" value="<?= htmlspecialchars($dino['nombre_cientifico_en']) ?>">
                    ...
                    <textarea id="descripcion_en" name="descripcion_en" class="editor-textarea"><?= htmlspecialchars($dino['descripcion_en']) ?></textarea>
            ...
            <div class="lang-row">
                <div class="lang-col">
                    ...
                    <input type="text" name="anio_descubrimiento" id="anio" value="<?= htmlspecialchars($dino['anio_descubrimiento']) ?>">
                </div>
                <div class="lang-col">
                    <label>🌿 Período</label>
                    <input type="text" name="periodo" id="periodo" value="<?= htmlspecialchars($dino['periodo']) ?>">
                </div>
            </div>
            ...
            <div class="lang-row">
                <div class="lang-col">
                    <label>🍖 Dieta</label>
                    <input type="text" name="dieta" id="dieta" value="<?= htmlspecialchars($dino['dieta']) ?>">
                </div>
                <div class="lang-col">
                    <label>📏 Tamaño</label>
                    <input type="text" name="tamano" id="tamano" value="<?= htmlspecialchars($dino['tamano']) ?>">
                </div>
            </div>
            ...
            <div class="lang-row">
                <div class="lang-col">
                    <label>⚖️ Peso</label>
                    <input type="text" name="peso" id="peso" value="<?= htmlspecialchars($dino['peso']) ?>">
                </div>
                <div class="lang-col">
                    <label>🌿 Period (English)</label>
                    <input type="text" name="periodo_en" id="periodo_en" value="<?= htmlspecialchars($dino['periodo_en']) ?>">
                </div>
            </div>
            ...
            <div class="lang-row">
                <div class="lang-col">
                    ...
                    <input type="text" name="dieta_en" id="dieta_en" value="<?= htmlspecialchars($dino['dieta_en']) ?>">
                </div>
                <div class="lang-col">
                    <label>📏 Size (English)</label>
                    <input type="text" name="tamano_en" id="tamano_en" value="<?= htmlspecialchars($dino['tamano_en']) ?>">
                </div>
            </div>
            ...
            <div class="lang-row">
                <div class="lang-col">
                    ...
                    <input type="text" name="peso_en" id="peso_en" value="<?= htmlspecialchars($dino['peso_en']) ?>">
                </div>
            ...
            <div class="imagen-actual">
                ...
                <img src="../img/<?= $dino['imagen'] ?>" alt="Imagen actual">
            </div>
            <?php endif; ?>
        ...
        <a href="listar_dinos.php" class="back">← Volver a la lista</a>
    </div>
