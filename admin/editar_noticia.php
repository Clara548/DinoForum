...
<head>
    <meta charset="UTF-8">
    <title>Editar Noticia - Con Traducción</title>
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="lang-row">
                <div class="lang-col">
                    ...
                    <label>Título *</label>
                    <input type="text" name="titulo" id="titulo_es" value="<?= htmlspecialchars($noticia['titulo']) ?>" required>
                    ...
                    <textarea id="contenido_es" name="contenido" class="editor-textarea"><?= htmlspecialchars($noticia['contenido']) ?></textarea>
                ...
                <div class="lang-col">
                    ...
                    <label>Title *</label>
                    <input type="text" name="titulo_en" id="titulo_en" value="<?= htmlspecialchars($noticia['titulo_en']) ?>" required>
                    <label>Content *</label>
                    <div class="editor-toolbar">
                    ...
                    <textarea id="contenido_en" name="contenido_en" class="editor-textarea"><?= htmlspecialchars($noticia['contenido_en']) ?></textarea>
            ...
            <div class="lang-row">
                <div class="lang-col">
                    <label>👤 Autor</label>
                    <input type="text" name="autor" id="autor" value="<?= htmlspecialchars($noticia['autor']) ?>" placeholder="Ej: Admin DinoForum">
                </div>
                <div class="lang-col">
                    <label>📅 Fecha *</label>
                    <input type="date" name="fecha" id="fecha" value="<?= $noticia['fecha'] ?>" required>
                </div>
            </div>
